...
export default function JavaPage() {
  const rawContent = getContentSafely('java.md', 'Java Cheatsheet');
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Java <span className="text-[#007AFF]">Cheatsheet</span>
          </h1>
          <p className="text-xl text-[#D1D1D1]">
            Master Java programming with comprehensive examples and best practices
          </p>
        </div>
