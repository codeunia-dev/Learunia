...
export default async function FlutterPage() {
  const content = await getContentSafely('flutter.md', 'Flutter Development Cheatsheet');

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0D1117] via-[#161B22] to-[#0D1117]">
      <ArticleStructuredData 
        title="Flutter Development Cheatsheet"
        description="Complete Flutter development reference with widgets, state management, and mobile app development"
        url="/flutter"
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#D1D1D1] max-w-2xl mx-auto">
            Cross-platform mobile development with Flutter, Dart, and beautiful native experiences
          </p>
        </div>
