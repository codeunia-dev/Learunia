...
export default function HTMLPage() {
  const rawContent = getContentSafely('html.md', 'HTML5 Cheatsheet');
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            HTML5 <span className="text-[#007AFF]">Cheatsheet</span>
          </h1>
          <p className="text-xl text-[#D1D1D1] max-w-2xl mx-auto">
            Structure web content with semantic HTML5 elements, forms, and accessibility features
          </p>
        </div>
