...
export default function NodeJSPage() {
  const rawContent = getContentSafely('nodejs.md', 'Node.js Cheatsheet');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0F0F1A] to-[#1A1A2E]">
      <ArticleStructuredData
        ...
        description="Learn Node.js server-side JavaScript development, APIs, modules, npm packages, and backend development"
        url="https://learn.codeunia.com/nodejs"
        subject="Node.js"
      />
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Node.js <span className="text-[#007AFF]">Cheatsheet</span>
          </h1>
          <p className="text-xl text-[#D1D1D1]">
            Server-side JavaScript with Node.js, Express, and modern backend development patterns
          </p>
        </div>
