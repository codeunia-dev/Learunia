...
export default async function SwiftPage() {
  const content = await getContentSafely('swift.md', 'Swift Programming Cheatsheet');

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0D1117] via-[#161B22] to-[#0D1117]">
      <ArticleStructuredData 
        title="Swift Programming Cheatsheet"
        description="Complete Swift programming reference with syntax, SwiftUI, and iOS development"
        url="/swift"
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#D1D1D1] max-w-2xl mx-auto">
            Modern iOS and macOS development with Swift, SwiftUI, and Apple frameworks
          </p>
        </div>
