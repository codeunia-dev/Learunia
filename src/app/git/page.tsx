...
export default function GitPage() {
  const rawContent = getContentSafely('git.md', 'Git Cheatsheet');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0F0F1A] to-[#1A1A2E]">
      <ArticleStructuredData
        ...
        description="Master Git version control with essential commands, branching strategies, and collaboration workflows"
        url="https://learn.codeunia.com/git"
        subject="Git"
      />
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Git <span className="text-[#007AFF]">Cheatsheet</span>
          </h1>
          <p className="text-xl text-[#D1D1D1]">
            Version control mastery with Git commands, branching strategies, and collaboration workflows
          </p>
        </div>
